...
class MetaModelTrainer:
    def __init__(self, data_dir: str = "user_data/data/binance", models_dir: str = "user_data/models"):
    ...
    def create_meta_dataset(self, X: pd.DataFrame, y_true: pd.Series, primary_model: Any) -> Tuple[pd.DataFrame, pd.Series]:
        """
    ...
    def run(self, pair: str):
        ...
        print(f"Final System Test Metrics:")
