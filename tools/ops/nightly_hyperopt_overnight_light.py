...
class NightlySharpeRatioObjectiveLight:
    ...
    def __init__(self, X: pd.DataFrame, y: pd.Series, close_prices: pd.Series, 
                 n_splits: int = 5, resource_monitor: Optional[ResourceMonitorLight] = None):
        """
...
class NightlyHyperparameterOptimizerLight:
    ...
    def optimize(self, 
        ...
        """
        logger.info(f"Starting overnight light hyperparameter optimization")
...
def main():
    ...
    print(f"  XGBoost Jobs:    1 (single-threaded)")
    ...
    try:
        ...
        print(f"Report: user_data/nightly_hyperopt_light/optimization_report_light.md")
        print("\n" + "="*70)
