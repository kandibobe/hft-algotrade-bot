...
import time
from typing import Optional, Any, Callable, Coroutine, Tuple, List, Dict, Union
from telegram import Update
from telegram.ext import ContextTypes
from telegram.constants import ParseMode
import html
from src.telegram_bot.services import data_fetcher, analysis
...
from src.telegram_bot.config_adapter import SHARED_DATA_FETCH_INTERVAL, API_COOLDOWN, NEWS_API_PAGE_SIZE
...
BaseFetchFunctionType = Callable[[aiohttp.ClientSession], Coroutine[Any, Any, Tuple[Optional[Any], str]]]
ArgFetchFunctionType = Callable[..., Coroutine[Any, Any, Tuple[Optional[Any], str]]]

async def _get_cached_or_fetch(
    cache_key_base: str,
    fetch_function: Union[BaseFetchFunctionType, ArgFetchFunctionType],
    context: ContextTypes.DEFAULT_TYPE,
    update: Update,
    lang_code: str,
    fetch_args: Optional[List[Any]] = None,
...
async def marketcap_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    async def _fetch_marketcap_data_adapter(session: aiohttp.ClientSession, limit: int) -> Tuple[Optional[List[Dict[str, Any]]], str]:
