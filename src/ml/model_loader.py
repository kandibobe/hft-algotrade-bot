...
class ModelLoader:
    ...
    def load_model_for_pair(self, pair: str) -> Tuple[Optional[Any], Optional[FeatureEngineer], List[str]]:
        """
...
def get_production_model(pair: str) -> Tuple[Optional[Any], Optional[FeatureEngineer], List[str]]:
