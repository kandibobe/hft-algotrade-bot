...
CONTAINERS_TO_MONITOR = ["stoic_freqtrade", "stoic_frequi", "stoic_postgres", "stoic_jupyter"]
...
class HealthMonitor:
    ...
    def get_metrics(self) -> dict:
        ...
        metrics = {"timestamp": datetime.now().isoformat(), "containers": {}}
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                logger.info(
                    f"📊 Health check complete: {healthy_count}/{len(results)} containers healthy"
                )
            ...
            self.notifier.send("🛑 Health Monitor Stopped\n\nManual shutdown detected", "WARNING")
        except Exception as e:
