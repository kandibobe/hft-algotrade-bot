...
class DataInspector:
    ...
    def show_available_data(self) -> None:
        ...
        if not data:
            ...
            print("  docker exec stoic_freqtrade freqtrade download-data \\")
            print("    --exchange binance \\")
            print("    --timeframe 5m \\")
            print("    --pairs BTC/USDT ETH/USDT \\")
            print("    --days 30")
            return
...
def main():
    parser = argparse.ArgumentParser(description="Inspect downloaded trading data")
    parser.add_argument("--pair", type=str, help="Pair to inspect (e.g., BTC/USDT)")
    ...
    parser.add_argument(
        "--data-dir", type=str, default="user_data/data/binance", help="Data directory"
    )
